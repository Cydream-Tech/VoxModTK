...
namespace UnityEditor.GUI
{
    ...
    [CustomEditor(typeof(VoxelPlayground.Mod.JsProperties))]
    //[CanEditMultipleObjects]
    public class JsProperties_CustomEditor : Editor
    {
        private Object _scriptObject;
        //实例引用
        private VoxelPlayground.Mod.JsProperties _instance;
        ...
        void OnEnable()
        {
            //Debug.Log("OnEnable");
            _scriptObject = null;
            _instance = target as VoxelPlayground.Mod.JsProperties;
            if (_instance == null)
                return;

            //script object
            var targetName = $"/{nameof(VoxelPlayground.Mod.JsProperties)}.cs";
            ...
            display.AddDrawer<StringDrawer>(typeof(VoxelPlayground.Mod.JsProperties.String));
            display.AddDrawer<NumberDrawer>(typeof(VoxelPlayground.Mod.JsProperties.Number));
            display.AddDrawer<BooleanDrawer>(typeof(VoxelPlayground.Mod.JsProperties.Boolean));
            display.AddDrawer<ComponentDrawer>(typeof(VoxelPlayground.Mod.JsProperties.Component));
            display.AddDrawer<ScriptableObjectDrawer>(typeof(VoxelPlayground.Mod.JsProperties.Object));
            display.AddDrawer<GameObjectArrayDrawer>(typeof(VoxelPlayground.Mod.JsProperties.GameObjectArray));
        ...
        private DrawerInfo CreateDrawerInfo()
        {
            ...
            if (_instance != null)
            {
                ...
                var fields = typeof(VoxelPlayground.Mod.JsProperties).GetFields(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
                foreach (var field in fields)
                {
                    Type elementType = field.FieldType.IsArray ? field.FieldType.GetElementType() : null;
                    if (elementType != null
                        && typeof(VoxelPlayground.Mod.JsProperties.IPair).IsAssignableFrom(elementType)
                        && serializedObject.FindProperty(field.Name) != null
                        && DisplayUtility.CheckFields(elementType))
                    {

                        var options = elementType.GetCustomAttribute<VoxelPlayground.Mod.JsProperties.OptionsAttribute>(false);
        ...
        void DisplayMenu()
        {
            ...
            if (menuFoldout)
            {
                ...
                {
                    VoxelPlayground.Mod.JsProperties.ResultPair[] pairs = _instance.GenPairs();
                    if (pairs != null)
                    {
    ...
    public class DisplayUtility
    {
        ...
        {
            FieldInfo index, key;
            return typeof(VoxelPlayground.Mod.JsProperties.IPair).IsAssignableFrom(type)
        ...
        public static string GenCode(VoxelPlayground.Mod.JsProperties.ResultPair[] pairs, string declareType, bool useFullname)
        {
            var resultCode = "";
        ...
        public static void PraseCode(JsProperties_CustomEditor editor, string code)
        {
    ...
    class ComponentDrawer : Drawer
    {
        protected override void DrawValue(Rect position, Rect valueRect)
        {
            element.valueNode.objectReferenceValue = EditorGUI.ObjectField(valueRect, string.Empty, element.valueNode.objectReferenceValue, typeof(Component), true);
        }
        ...
        class ScriptableObjectDrawer : Drawer
        {
            protected override void DrawValue(Rect position, Rect valueRect)
            {
                element.valueNode.objectReferenceValue = EditorGUI.ObjectField(valueRect, string.Empty, element.valueNode.objectReferenceValue, typeof(Object), false);
            }
        }
